...
# sleep 1
# polybar -c ~/.config/polybar/config.ini monitor-bar1 &
# polybar -c ~/.config/polybar/config.ini monitor-bar2 &
# polybar -c ~/.config/polybar/config.ini monitor-bar3 &
# polybar -c ~/.config/polybar/config.ini monitor-bar4 &
